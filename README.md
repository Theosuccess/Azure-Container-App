...
5. FIFTH STEP: Enable ingress and set port to 4173, and allow trafficfrom anywhere
...
7. FINAL RESULT: You should see the container app details as this if deployment is successful
